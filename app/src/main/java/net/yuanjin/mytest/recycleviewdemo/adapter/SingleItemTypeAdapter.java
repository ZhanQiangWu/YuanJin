...
public abstract  class SingleItemTypeAdapter<T> extends RecyclerView.Adapter<ViewHolder>{
    ...
    public SingleItemTypeAdapter(Context context, int layoutId, List<T> datas){
        mContext = context;
